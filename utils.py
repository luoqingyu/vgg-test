...
class DataIterator:
    def __init__(self, data_dir,istrain=True):
        ...
        if istrain:
            ...
            fa = open("/home/lqy/project/OCR/ocr_cnn_lstm_ctc/data/train/word_list.txt", 'r')
            for line in fa.readlines():
                img_path = '/home/lqy/project/OCR/ocr_cnn_lstm_ctc/data/train/'+line.split(" ")[-2]
            ...
            i = 0
            fa = open("/home/lqy/project/OCR/ocr_cnn_lstm_ctc/data/test/word_list.txt", 'r')
            for line in fa.readlines():
                img_path = '/home/lqy/project/OCR/ocr_cnn_lstm_ctc/data/test/' + line.split(" ")[-2]
                img_label = line.split(" ")[-1]
                img_label = img_label.replace('\n', '')
                if os.path.exists(img_path):
                    try:
