...
tf.app.flags.DEFINE_string('train_dir','/home/work/data/annotation_train.txt', 'the train data dir')
tf.app.flags.DEFINE_string('val_dir','/home/work/data/annotation_test.txt', 'the val data dir')
